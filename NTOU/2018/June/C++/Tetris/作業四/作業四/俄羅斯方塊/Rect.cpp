...
void Rect::editIntroduce(int x, int y, char *str){
...
void Rect::Teris(){
	...
	while(!m_gameOver){//gameNotOver
		int shapeNum = next;
		next = rand() % 6;
		Object obj(colorTable[shapeNum] , Point(m_right/2,m_top), shape[shapeNum]);
